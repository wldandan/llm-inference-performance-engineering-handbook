...
| 路径 | 状态 | 说明 |
|---|---|---|
| `LLM 推理性能优化实战/` | **当前唯一权威版本** | 30 章 / 7 Part 正文与 Workshops。目录名暂时保留，课程名称以 v1.0 大纲为准。 |
...
当前章节 Demo 统一从 [`code/README.md`](code/README.md) 进入。目录按 `code/chapter01`、`code/chapter02`……命名；尚未实现的章节只登记状态，不保留空目录。
