"""Chapter 07: CUDA Graph 与 Kernel Optimization demo.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Synthetic benchmark for chapter 07: CUDA Graph 与 Kernel Optimization")
