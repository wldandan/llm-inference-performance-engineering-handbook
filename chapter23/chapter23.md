...
![优化前先绑定 Scalability Root Cause](figures/fig23-01__scalability_root_cause.svg)

图23-1：优化前先绑定 Scalability Root Cause。

## 23.1 优化前先绑定 Scalability Root Cause
...
![Quantization](figures/fig23-02_quantization.svg)
...
![Tensor Parallel](figures/fig23-03_tensor_parallel.svg)

图23-3：Tensor Parallel。

## 23.3 Tensor Parallel
...
![Pipeline Parallel](figures/fig23-04_pipeline_parallel.svg)

图23-4：Pipeline Parallel。

## 23.4 Pipeline Parallel
...
![Expert Parallel](figures/fig23-05_expert_parallel.svg)

图23-5：Expert Parallel。

## 23.5 Expert Parallel
...
![Replica](figures/fig23-06_replica.svg)
...
![Load Balance](figures/fig23-07_load_balance.svg)
...
![Autoscaling](figures/fig23-08_autoscaling.svg)
...
![课堂案例：加机器为什么没有线性收益](figures/fig23-09_figure.svg)

图23-9：课堂案例：加机器为什么没有线性收益。
...
![Scalability 优化方法 的章节边界](figures/fig23-10_figure.svg)

图23-10：Scalability 优化方法 的章节边界。
