...
| 章节 | 核心问题 |
|---|---|
| Chapter 14 Decode 工作机制 | Decode 阶段如何逐 token 生成？ |
| Chapter 15 Decode 性能分析 | 为什么 Decode 更容易受 memory bound 影响？（【调整】新增 CPU Dispatch / Kernel Launch Overhead 根因条目，对应 Chapter 16 新增的优化手段） |
| Chapter 16 Decode 优化方法 | 面对 Decode 瓶颈应该选择哪些优化方法？（【调整】新增跨副本缓存感知路由 Cache-Aware Routing；【移入】CUDA Graph / Kernel Fusion / Persistent Kernel 从 Chapter 12 移入，因为这三项针对的"小 kernel 高频启动开销"与 Decode 瓶颈特征更吻合） |
| Chapter 17 Decode 实战验证 | 如何证明 Decode 优化真的改善 TPOT 和生成效率？ |
