...
- 权威课程结构是 7 Part、30 Chapter，学习路径为“启动服务 → 理解推理 → 测量性能 → 定位瓶颈 → 优化单 GPU → 优化 Serving/RAG/Agent → 规模化部署 → 综合项目”。证据见 [`content/02_Course_Outline_v1.0.md`](../../content/02_Course_Outline_v1.0.md)。
