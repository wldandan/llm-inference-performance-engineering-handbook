...
> V0.2 权威大纲见 [`02_Course_Outline_v0.2.md`](02_Course_Outline_v0.2.md)。本文件与旧版文件均作为历史版本保留，后续正文重构以 V0.2 大纲为准。
...
课程设计理念和统一性能分析方法见 `01_Course_Design.md`；章节编写方式见 `03_Course_Template.md`；每章配套的动手实验见 `../../content/workshops/`（与历史遗留的 `../../_archive/lesson/` 课堂讲稿是两种不同格式，区分见项目根目录 `README.md`）。
