...
> 历史版本：当前迁移基线见 [`04_Content_Migration_Plan_v0.2.md`](04_Content_Migration_Plan_v0.2.md)。
...
旧版正文以 Git 提交 `c4964fc` 为只读快照。后续直接在 `ch01`–`ch30` 原位重构，需要旧材料时从该提交读取，不在工作区复制第二套正文。
